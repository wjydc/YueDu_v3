...
namespace Com.WxPayAPI2
{
    public class JsApiPay
    {
        ...
        public JsApiPay(string host, string path, string queryString)
        {
            Host = host;
            Path = path;
        ...
        */
        ...
        public WxPayData GetUnifiedOrderResult(string body, string out_trade_no)
        {
            //统一下单
            WxPayData data = new WxPayData();
