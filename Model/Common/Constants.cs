...
namespace Model.Common
{
    public class Constants
    {
        ...
        public struct SecurityKey
        {
            ...
            public const string userAESId = "EQP2yAP4oAW5w8Fv5cn82T1pdvGnk";
            public const string userAESKey = "2017ReaderWebBookReadChapter_Key";
            public const string userAESIV = "2017ReaderWeb_IV";
